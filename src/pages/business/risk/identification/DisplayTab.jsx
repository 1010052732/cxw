...
export default function DisplayTab({ onGoCase }) {
  ...
  return (
    <>
      <div className="business-filter-bar">
        ...
        {onGoCase && <Text type="link" onClick={onGoCase} style={{ cursor: 'pointer' }}>风险案例库 →</Text>}
      </div>
      ...
      <div className="business-panel">
        ...
        <Table rowKey="id" size="small" pagination={{ pageSize: 8 }} dataSource={data.tracking} columns={[
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} lg={10}>
          <div className="business-panel">
            ...
            <Button block onClick={() => navigate('/risk/response')}>查看完整处置档案</Button>
          </div>
        </Col>
      </Row>
    </>
