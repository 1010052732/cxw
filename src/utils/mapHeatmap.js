...
export const MAP_LAYER_META = {
  ...
  cluster: { label: '制造业集群', color: '#d48806', channel: 'gold' },
  resource: { label: '资源禀赋', color: '#a0d911', channel: 'success' },
  hinterland: { label: '港口腹地', color: '#2f54eb', channel: 'blue' },
  industry: { label: '产业园区', color: '#d48806', channel: 'gold' },
  ftz: { label: '自贸区', color: '#52c41a', channel: 'success' },
  risk: { label: '政治风险', color: '#faad14', channel: 'warning' },
  disaster: { label: '自然灾害', color: '#ff4d4f', channel: 'brand' },
